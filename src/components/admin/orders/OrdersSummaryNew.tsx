...
const OrdersSummaryNew = ({ summary }: OrderSummaryProps) => {
  const { totalOrders, pendingOrders, completedOrders, cancelledOrders, totalRevenue } = summary;
...
export default OrdersSummaryNew;
