    ...
    try {
      ...
      if (syncResult && syncResult.success) {
        toast({
          ...
          description: `Processed ${syncResult.processed} records: ${syncResult.inserted} inserted, ${syncResult.updated} updated`,
        });
      } else if (syncResult) {
        toast({
          variant: "destructive",
          title: "Sync Completed With Errors",
          description: `${syncResult.errors} errors occurred during synchronization`,
        });
      }
    } catch (error) {
      setShowResult(true);
    ...
    <div className="space-y-6">
      <Tabs defaultValue="sync" className="w-full">
        ...
        <TabsContent value="sync" className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              {isSyncing ? "Syncing..." : "Sync Talent Data"}
            </Button>
          </div>
        ...
        <TabsContent value="stats" className="space-y-6">
          ...
          {!isCountsLoading && registrationCounts && (
