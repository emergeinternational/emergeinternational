...
const Dashboard = () => {
  ...
  return (
    <AdminLayout>
      ...
      {/* TeleBirr Payments */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold mb-4">TeleBirr Payments</h2>
            ...
            <tbody>
              {recentPayments.map((payment) => (
                <tr key={payment.id} className="border-t">
                  ...
                  <td className="px-4 py-3">{payment.city}</td>
                  <td className="px-4 py-3">{payment.id}</td>
                  <td className="px-4 py-3">
                    <button className="bg-emerge-darkBg text-white px-4 py-1 text-sm rounded">
                      ACTIVATE
                    </button>
                  </td>
                </tr>
      ...
      <div>
        ...
        <div className="bg-white p-5 rounded shadow">
          ...
          <Link to="/admin/activity" className="block text-emerge-gold mt-4 text-sm">
            View all activity
          </Link>
        </div>
      </div>
